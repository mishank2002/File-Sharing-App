"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{9009:function(e,t,r){r.d(t,{IO:function(){return sr},JU:function(){return iV},PL:function(){return sg},QT:function(){return sm},ad:function(){return iP},ar:function(){return si},hJ:function(){return iL},pl:function(){return sy},r7:function(){return sw}});var n,i,s,a,o=r(4684),l=r(6574),u=r(9858),h=r(8954),c=r(1197),d=r(9079);let f="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class t3{constructor(e,t,r,n,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=n,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,r){let n=new Map;return n.set(e,t8.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new t3(F.min(),n,new eu(O),tm,tE())}}class t8{constructor(e,t,r,n,i){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=n,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new t8(r,t,tE(),tE(),tE())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let r4=null;function r9(){return null===r4?r4=268435456+Math.round(2147483648*Math.random()):r4++,"0x"+r4.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new S(I.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,r={}){let n=new C;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){let s=new nQ(r,new im({next:r=>{t.enqueueAndForget(()=>nB(e,s)),r.fromCache&&"server"===n.source?i.reject(new S(I.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(r)},error:e=>i.reject(e)}),{includeMetadataChanges:!0,ta:!0});return nq(e,s)})(await i_(e),e.asyncQueue,t,r,n)),n.promise})(r,e._query).then(r=>new sf(t,n,e,r)))}function sy(e,t,r){var n;e=iD(e,ix);let i=iD(e.firestore,iM),s=(n=e.converter)?r&&(r.merge||r.mergeFields)?n.toFirestore(t,r):n.toFirestore(t):t;return sv(i,[(function(e,t,r,n,i,s={}){let a,o;let l=e.Cu(s.merge||s.mergeFields?2:0,t,r,i);i1("Data must be an object, but it was:",l,n);let u=iZ(n,l);if(s.merge)a=new em(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let n of s.mergeFields){let i=i2(t,n,r);if(!l.contains(i))throw new S(I.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);i8(e,i)||e.push(i)}a=new em(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new iQ(new eB(u),a,o)})(iY(i),"setDoc",e._key,s,null!==e.converter,r).toMutation(e._key,tM.none())])}function sw(e,t,r,...n){e=iD(e,ix);let i=iD(e.firestore,iM),s=iY(i);return sv(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof iB?function(e,t,r,n,i,s){let a=e.Cu(1,t,r),o=[i2(t,n,r)],l=[i];if(s.length%2!=0)throw new S(I.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i2(t,s[e])),l.push(s[e+1]);let u=[],c=eB.empty();for(let e=o.length-1;e>=0;--e)if(!i8(u,o[e])){let t=o[e],r=l[e];r=(0,h.m9)(r);let n=a.yu(t);if(r instanceof iJ)u.push(t);else{let e=iX(r,n);null!=e&&(u.push(t),c.set(t,e))}}return new iG(c,new em(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,r,n):function(e,t,r,n){let i=e.Cu(1,t,r);i1("Data must be an object, but it was:",i,n);let s=[],a=eB.empty();return eo(n,(e,n)=>{let o=i9(t,e,r);n=(0,h.m9)(n);let l=i.yu(o);if(n instanceof iJ)s.push(o);else{let e=iX(n,l);null!=e&&(s.push(o),a.set(o,e))}}),new iG(a,new em(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tM.exists(!0))])}function sv(e,t){return function(e,t){let r=new C;return e.asyncQueue.enqueueAndForget(async()=>n9(await iv(e).then(e=>e.syncEngine),t,r)),r.promise}(iF(e),t)}new WeakMap,function(e=!0){p=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:r,options:n})=>{let i=t.getProvider("app").getImmediate(),s=new iM(new N(t.getProvider("auth-internal")),new L(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new S(I.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new eC(e.options.projectId,t)}(i,r),i);return n=Object.assign({useFetchStreams:e},n),s._setSettings(n),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(f,"4.5.0",void 0),(0,o.KN)(f,"4.5.0","esm2017")}()}}]);